						...
						<li class=user_main_c>
							<div class=user_main_box>
								...
								<ul>
									...
									<li class=user_main_input>
										<img class="vc-pic" width="65" height="23" title="点击刷新验证码" src="RandomImage?time=new Date().getTime()">
										<input class="txtvalidatecodecssclass easyui-validatebox" data-options="required:true,missingMessage:'验证码不能为空.'" maxlength="4" type="text" name="verifyCode">
									</li>
								</ul>
							</div>
						</li>
