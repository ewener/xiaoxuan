package com.asiainfo.dmcweb.image;
...
public class RandomGraphic {
	...
	protected String draw(String charValue, String graphicFormat,
		...
		for (int i = 0; i < charCount; i++) {
		    ...
		    //trans.rotate((double)random.nextInt(6)-1);
